...
import { Btn, Lbl } from "../../components/dashboard/UI";

// ===== CALL LOGS PAGE =====
// View history of all calls
...
const CallLogsPage = () => {
  ...
  const loadCalls = async () => {
    try {
      ...
      const response = await callService.getAll(filters);
  ...
  return (
    <div style={{ padding: "36px 42px" }}>
      ...
      >
        ...
        <Btn variant="secondary" onClick={loadCalls}>
          ↻ Refresh
        </Btn>
      </div>
      ...
      {/* Loading State */}
      {loading ? (
        <div style={{ textAlign: "center", padding: 40, color: "var(--txt2)" }}>
          Loading calls...
        </div>
      ) : calls.length === 0 ? (
        <div
        ...
        >
          ...
          <div style={{ color: "var(--muted)" }}>
            Start by sending a call from the Send Call page
          </div>
        </div>
      ) : (
        /* Calls Table */
