...
const DASHBOARD_CSS = `
  ...
  .field-input{background:var(--elev);border:1px solid var(--bdr);border-radius:10px;color:var(--txt);font-family:'Syne',sans-serif;font-size:14px;padding:12px 16px;outline:none;transition:border-color 0.2s,box-shadow 0.2s;width:100%;}
